...
public class InventoryController {
    ...
    private ResponseEntity<String> handleServiceException(Exception e, String defaultMessage, int statusCode) {
        String message = e instanceof RuntimeException ? e.getMessage() : defaultMessage;
    ...
    public ResponseEntity<String> recordMovement(
        ...
        try {
            ...
            return handleServiceException(e, "Error recording movement", 400);
        }
    }
    ...
    public ResponseEntity<String> deleteProduct(@PathVariable Long id) {
        try {
            ...
            return handleServiceException(e, "An unexpected error occurred while deleting the product. Please try again or contact support.", 500);
        }
    }
    ...
    @GetMapping("/agents/options")
    public ResponseEntity<List<DeliveryAgentOptionDto>> getDeliveryAgentOptions() {
        return ResponseEntity.ok(inventoryService.getDeliveryAgentOptions());
    }
